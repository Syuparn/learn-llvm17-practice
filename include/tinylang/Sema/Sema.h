...
public:
  ...
  ModuleDeclaration *
  actOnModuleDeclaration(llvm::SMLoc Loc,
                         llvm::StringRef Name);
  void actOnModuleDeclaration(ModuleDeclaration *ModDecl,
                              ...
                              DeclList &Decls,
                              StmtList &Stmts);
  void actOnImport(llvm::StringRef ModuleName,
                   IdentList &Ids);
  ...
  actOnProcedureDeclaration(llvm::SMLoc Loc,
                            llvm::StringRef Name);
  ...
  void actOnProcedureDeclaration(
      ...
      StmtList &Stmts);
  void actOnAssignment(StmtList &Stmts, llvm::SMLoc Loc,
                       Decl *D, Expr *E);
  void actOnProcCall(StmtList &Stmts, llvm::SMLoc Loc,
  ...
  void actOnWhileStatement(StmtList &Stmts, llvm::SMLoc Loc,
                           Expr *Cond,
                           StmtList &WhileStmts);
  void actOnReturnStatement(StmtList &Stmts,
                            llvm::SMLoc Loc, Expr *RetVal);
  ...
  Expr *actOnPrefixExpression(Expr *E,
                              const OperatorInfo &Op);
  Expr *actOnIntegerLiteral(llvm::SMLoc Loc,
                            llvm::StringRef Literal);
  Expr *actOnVariable(Decl *D);
  Expr *actOnFunctionCall(Decl *D, ExprList &Params);
  Decl *actOnQualIdentPart(Decl *Prev, llvm::SMLoc Loc,
                           llvm::StringRef Name);
};
