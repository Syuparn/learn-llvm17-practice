...
using IdentList =
    std::vector<std::pair<llvm::SMLoc, llvm::StringRef>>;
...
public:
  Decl(DeclKind Kind, Decl *EnclosingDecL, llvm::SMLoc Loc,
       llvm::StringRef Name)
...
public:
  ModuleDeclaration(Decl *EnclosingDecL, llvm::SMLoc Loc,
                    llvm::StringRef Name)
...
public:
  ConstantDeclaration(Decl *EnclosingDecL, llvm::SMLoc Loc,
...
public:
  TypeDeclaration(Decl *EnclosingDecL, llvm::SMLoc Loc,
                  llvm::StringRef Name)
...
public:
  VariableDeclaration(Decl *EnclosingDecL, llvm::SMLoc Loc,
                      llvm::StringRef Name,
                      TypeDeclaration *Ty)
...
public:
  FormalParameterDeclaration(Decl *EnclosingDecL,
                             llvm::SMLoc Loc,
                             llvm::StringRef Name,
                             TypeDeclaration *Ty,
                             bool IsVar)
...
public:
  ProcedureDeclaration(Decl *EnclosingDecL, llvm::SMLoc Loc,
                       llvm::StringRef Name)
...
public:
  IntegerLiteral(llvm::SMLoc Loc, const llvm::APSInt &Value,
                 TypeDeclaration *Ty)
